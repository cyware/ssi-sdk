...
func VerifyPresentationSubmissionVP(def PresentationDefinition, vp credential.VerifiablePresentation) ([]VerifiedSubmissionData, error) {
	...
	for _, inputDescriptor := range def.InputDescriptors {
		...
		// TODO(gabe) support nested paths in presentation submissions https://github.com/cyware/ssi-sdk/issues/73
		...
		// TODO(gabe) is_holder and same_subject cannot yet be implemented https://github.com/cyware/ssi-sdk/issues/64
		// TODO(gabe) check credential status https://github.com/cyware/ssi-sdk/issues/65
	}
