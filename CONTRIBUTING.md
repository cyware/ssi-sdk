...
* Raise an issue or feature request in our [issue tracker](https://github.com/cyware/ssi-sdk/issues)
...
via [GitHub Issues](https://github.com/cyware/ssi-sdk/issues).
...
We use [GitHub Projects](https://github.com/orgs/cyware/projects/17) to track our work.
...
using [GitHub Actions](https://github.com/cyware/ssi-sdk/actions).
...
* Start by proposing a change either in [GitHub Issues](https://github.com/cyware/ssi-sdk/issues) or on our Discord in the `#ssi` channel
